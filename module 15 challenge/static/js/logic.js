...
let usgsURL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/2.5_month.geojson";
...
function createFeatures(eqData) {
    ...
    function pointToLayer(feature, coords) {
        ...
        let color = depth >= 90 ? "red" : depth >= 70 ? "pink" : depth >= 50 ? "orange" : depth >= 30 ? "yellow" : depth >= 10 ? "green" : "blue";
